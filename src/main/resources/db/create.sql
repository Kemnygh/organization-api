...
CREATE TABLE users (id serial PRIMARY KEY, first_name VARCHAR, last_name varchar, staff_id VARCHAR UNIQUE, user_position VARCHAR, phone_no VARCHAR UNIQUE, email VARCHAR UNIQUE, photo VARCHAR, created BIGINT, updated BIGINT, deleted VARCHAR DEFAULT 'FALSE');
